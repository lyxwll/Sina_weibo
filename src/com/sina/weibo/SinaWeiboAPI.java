...
public class SinaWeiboAPI {
	 ...
	 **/
	private static final String URL_STATUSES_UPLOAD_URL_TEXT = URL_STATUSES
	...
	public void getAccessTokenByCode(String code, RequestListener listener) {
		...
		WeiboParameters params = new WeiboParameters(accessToken);
		...
		// AsyncWeiboRunner.request(URL_ACCESS_TOKEN, params, HTTPMETHOD_POST,
		// listener);
