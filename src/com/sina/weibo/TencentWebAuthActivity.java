...
public class TencentWebAuthActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (!Util.isNetworkAvailable(this)) {
			...
			try {
				...
				if (clientId == null || "".equals(clientId) || redirectUri == null
						|| "".equals(redirectUri)) {

					Toast.makeText(TencentWebAuthActivity.this, "请在配置文件中填写相应的信息",
	...
	public void jumpResultParser(String result) {
		...
		if (!TextUtils.isEmpty(accessToken)) {
			...
			PreferenceUtil.getInstance(context).saveString(Constants.PREF_TX_ACCESS_TOKEN,
					accessToken);
			...
			PreferenceUtil.getInstance(context).saveString(Constants.PREF_TX_REFRESH_TOKEN,
					refreshToken); // 总是为null
